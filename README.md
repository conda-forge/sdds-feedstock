...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sdds-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14597&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sdds-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sdds` can be installed with:

```
conda install sdds
```

It is possible to list all of the versions of `sdds` available on your platform with:
